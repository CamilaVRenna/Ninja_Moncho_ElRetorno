...
export default class Nivel2 extends Phaser.Scene {
  ...
  create() {
    ...
    const capaPlataformas = map.addTilesetImage("plataforma", "platform");
    ...
    this.physics.add.overlap(
      ...
      // Establecer velocidad y dirección inicial del enemigo
      enemy.speed = 2;
      enemy.direction = 1;
    ...
    this.bomb.setVelocity(200, 200);
     ...
     //add music
    this.backGroundMusic = this.sound.add("musicLevel2", { loop: true , volume: 0.15 });
